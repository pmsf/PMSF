...
function pokestopLabel(item) {
    ...
    if (!noConvertPokestops) {
        str += '<center><div>' + i8ln('Convert to Gym') + '<i class="fas fa-sync-alt convert-pokestop" style="margin-top: 2px; vertical-align: middle; font-size: 1.5em;" onclick="openConvertPokestopModal(event);" data-id="' + item['pokestop_id'] + '"></i></div></center>'
    }
    str += '<div><center>' +
